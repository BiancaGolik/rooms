...
var menu = [];
menu['home'] = "Home";
menu['short'] = "Apartamenty";
menu['long'] = "Wynajem długoterminowy";
menu['cooperation'] = "Dla właścicieli";
menu['aboutUS'] = "O nas";
...
function getSingleBed(n) {
    return n > 4 ? "łóżek pojedynczych" : (n > 1 ? "łóżka pojedyncze" : "łóżko pojedyncze");
}
function getDoubleBed(n) {
    return n > 4 ? "łóżek podwójnych" : (n > 1 ? "łóżka podwójne" : "łóżko podwójne");
}
function getSingleSofa(n) {
    return n > 4 ? "sof pojedynczych" : (n > 1 ? "sofy pojedyncze" : "sofa pojedyncza");
}
function getDoubleSofa(n) {
    return n > 4 ? "sof podwójnych" : (n > 1 ? "sofy podwójne" : "sofa podwójne");
}
function getBunkleBed(n) {
    return n > 4 ? "łóżek piętrowych" : (n > 1 ? "łóżka piętrowe" : "łóżko piętrowe");
}
...
one['wrongBrowswer'] = "Przepraszamy, formularz niedostępny. Prosimy skorzystać z innej przeglądarki.";
one['bedsTitle'] = "Konfiguracja łóżek";
